...
function showMeme() {
    ...
    const meme_container = document.querySelector('.meme-content');
    const newImg = document.createElement('img');
    newImg.setAttribute('src',randomMemeUrl);
    clearAll();
    meme_container.appendChild(newImg);
...
function showJoke() {
    ...
    const joke_container = document.querySelector('.joke-content');
    const newPar = document.createElement('p');
    newPar.textContent = randomJokeText; 
    clearAll();
    joke_container.appendChild(newPar);
...
function showQuote() {
    ...
    const quote_container = document.querySelector('.quote-content');
    const quotePar = document.createElement('p');
    const authorPar = document.createElement('p');
    quotePar.textContent = randomQuote.quote;
    authorPar.textContent = " - "+randomQuote.author;
    clearAll();
    quote_container.appendChild(quotePar);
    quote_container.appendChild(authorPar);
...
function showRiddle() {
    ...
    const riddle_container = document.querySelector('.riddle-content');
    ...
    clearAll();
    riddle_container.appendChild(questionEle);
    riddle_container.appendChild(answerEle);
  }
  
  
function revealAnswers() {
    const riddle_container = document.querySelector('.riddle-content');
    const riddle = riddle_container.querySelector('p');
    ...
    if(riddle && answer.hidden){
      ...
      alert('There is no Riddle!!!Please select riddle');
    }
    else{
